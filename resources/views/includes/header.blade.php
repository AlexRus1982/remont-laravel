...
<nav class="navbar px-3 py-0 w-100" style="user-select: none;">
  ...
  <div class="navbar-item">Контакты</div>
  <div class="navbar-item">Акции</div>
  <div class="navbar-phone">+7(800) 999-99-99</div>
  <div class="navbar-social">
    <span class="mx-2 social-icon">
...
<div class="sub-header w-100 align-items-center" style="user-select: none;">
  ...
  <div class="catalog-button-wrapper ms-4 d-flex align-items-center" style="margin-top: 7px;">
    <div class="dropdown">
      ...
      <div class="catalog-button py-1 px-3 d-flex align-items-center" role="button" data-bs-toggle="dropdown" aria-expanded="false">
        <div class="catalog-button-icon">
          <svg 
            focusable="false"
            aria-hidden="true"
            width="18"
        ...
        <div class="catalog-button-text ms-2">Каталог</div>
      </div>
      ...
      <div class="dropdown-menu px-3 mt-2 shadow">
        ...
        <li class="stb__item">Инструменты</li>
        <li class="stb__item">Разное</li>
      </div>

    </div>
  </div>

  <div class="search-group input-group ms-auto me-auto" style="height: 30px; max-width: 600px;">
    <input type="text" class="form-control" placeholder="Поиск по сайту" aria-label="Поиск по сайту" aria-describedby="search-button">
    <span class="input-group-text" id="search-button" style="background: var(--accent-color); color: #FFF;">
  ...
  <div class="login-info" style="height: 30px;">
    ...
    @auth
      <span class="px-3" id="logout-icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" fill="currentColor" class="bi bi-door-open" viewBox="0 0 16 16">
