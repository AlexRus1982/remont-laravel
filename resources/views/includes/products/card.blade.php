...
<a class="card" target="_blank" rel="noopener noreferrer" href="/product/{{$item['URL адрес']}}" style="text-decoration: none; color: #000000; border:none; background: none;">
    <div class="card m-2 ms-0 shadow p-0" style="min-width: 17rem; width: 17rem; height: 430px; margin-top: 13px!important; margin-bottom: 13px!important; margin-right: 22px!important;">
        ...
        <div class="card-body d-flex flex-column">
            <h5 class="card-title" style="text-align: start; height: 40; line-height: 20px; display: -webkit-box; -webkit-box-orient: vertical; -webkit-line-clamp: 2; overflow: hidden;">{{$item['Наименование']}}</h5>
            <p class="card-text mt-auto" style="text-align: start;">{{$formatedPrice}}<svg style="margin: 0px 0px 3px 0px;" width="16px" height="16px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- <div class="basketButton btn btn-primary mt-auto d-flex flex-row" item_id="{{ $item_id }}">
                <div class="w-100">В корзину</div>
                <div>
            ...
            <div class="btn-group" role="group">
                <button type="button" class="basketButton btn btn-primary" item_id="{{ $item_id }}" style="border-color: white; white-space: nowrap;">В корзину</button>
